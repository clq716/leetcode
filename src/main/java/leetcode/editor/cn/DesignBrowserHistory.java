...
// 
//
// Related Topics 栈 设计 数组 链表 数据流 双向链表 👍 120 👎 0
...
public class DesignBrowserHistory{
    public static void main(String[] args) {
        BrowserHistory solution = new DesignBrowserHistory().new BrowserHistory("leetcode.com");
    }
...
class BrowserHistory {
    ...
    public void visit(String url) {
        Node next = new Node(url, current, null);
        current.next = next;
        current = next;
    }
