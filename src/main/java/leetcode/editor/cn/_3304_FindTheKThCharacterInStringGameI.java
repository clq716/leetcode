...
<div><div>Related Topics</div><div><li>位运算</li><li>递归</li><li>数学</li><li>模拟</li></div></div><br><div><li>👍 22</li><li>👎 0</li></div>
*/

package leetcode.editor.cn;
public class _3304_FindTheKThCharacterInStringGameI{
    public static void main(String[] args) {
        Solution solution = new _3304_FindTheKThCharacterInStringGameI().new Solution();
    }
