...
<div><div>Related Topics</div><div><li>数组</li><li>动态规划</li><li>堆（优先队列）</li></div></div><br><div><li>👍 67</li><li>👎 0</li></div>
*/
...
public class _2163_MinimumDifferenceInSumsAfterRemovalOfElements{
    public static void main(String[] args) {
        Solution solution = new _2163_MinimumDifferenceInSumsAfterRemovalOfElements().new Solution();
    }
