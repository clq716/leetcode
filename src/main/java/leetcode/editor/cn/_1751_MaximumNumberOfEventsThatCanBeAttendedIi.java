...
<div><div>Related Topics</div><div><li>数组</li><li>二分查找</li><li>动态规划</li><li>排序</li></div></div><br><div><li>👍 131</li><li>👎 0</li></div>
*/
...
public class _1751_MaximumNumberOfEventsThatCanBeAttendedIi{
    public static void main(String[] args) {
        Solution solution = new _1751_MaximumNumberOfEventsThatCanBeAttendedIi().new Solution();
    }
...
class Solution {
    public int maxValue(int[][] events, int k) {
        ...
        Arrays.sort(events, Comparator.comparingInt(a -> a[1])); // 按照结束时间排序
        int n = events.length;
