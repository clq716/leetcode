...
<div><div>Related Topics</div><div><li>位运算</li><li>脑筋急转弯</li><li>枚举</li></div></div><br><div><li>👍 59</li><li>👎 0</li></div>
*/

package leetcode.editor.cn;
public class _2749_MinimumOperationsToMakeTheIntegerZero{
    public static void main(String[] args) {
        Solution solution = new _2749_MinimumOperationsToMakeTheIntegerZero().new Solution();
        solution.makeTheIntegerZero(12,-55);
    }
