...
public class _3541_FindMostFrequentVowelAndConsonant{
    public static void main(String[] args) {
       Solution solution = new _3541_FindMostFrequentVowelAndConsonant().new Solution();
    }
...
class Solution {
    public int maxFreqSum(String s) {
		...
		boolean[] yuanyin = new boolean['z'+1];
		yuanyin['a'] = true;
		yuanyin['e'] = true;
		yuanyin['i'] = true;
		yuanyin['o'] = true;
