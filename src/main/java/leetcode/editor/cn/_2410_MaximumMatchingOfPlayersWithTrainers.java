...
public class _2410_MaximumMatchingOfPlayersWithTrainers{
    public static void main(String[] args) {
       Solution solution = new _2410_MaximumMatchingOfPlayersWithTrainers().new Solution();
       solution.matchPlayersAndTrainers(new int[]{1,1,1,}, new int[]{10});
    }
...
class Solution {
    public int matchPlayersAndTrainers(int[] players, int[] trainers) {
        ...
        int ans = 0;
        label: for (int p = 0, t = 0; p < players.length; p++) {
