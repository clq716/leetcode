...
<div><div>Related Topics</div><div><li>数组</li><li>哈希表</li><li>滑动窗口</li></div></div><br><div><li>👍 730</li><li>👎 0</li></div>
*/
...
class Solution {
    public int totalFruit(int[] fruits) {
        ...
        for (int r = 0, l = 0; r < fruits.length; r++) {
            ...
            while (cnt.size() > 2) {
                int lf = fruits[l++];
                if (cnt.get(lf) == 1) cnt.remove(lf);
                else cnt.put(lf, cnt.get(lf) - 1);
            }
