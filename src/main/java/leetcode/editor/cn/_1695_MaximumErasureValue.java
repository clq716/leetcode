...
<div><div>Related Topics</div><div><li>数组</li><li>哈希表</li><li>滑动窗口</li></div></div><br><div><li>👍 131</li><li>👎 0</li></div>
*/
...
public class _1695_MaximumErasureValue{
    public static void main(String[] args) {
        Solution solution = new _1695_MaximumErasureValue().new Solution();
...
class Solution {
    public int maximumUniqueSubarray(int[] nums) {
        ...
        for (int l = 0, r = 0; r < nums.length; r++) {
            Integer duplicated = cnt.get(nums[r]);
            if (duplicated != null) {
                //将左指针移动到与右指针数值重复的位置
                while (l <= duplicated) {
                    cnt.remove(nums[l]);
