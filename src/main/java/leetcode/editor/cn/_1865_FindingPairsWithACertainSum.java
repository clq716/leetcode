...
//       Solution solution = new _1865_FindingPairsWithACertainSum().new Solution();
    }
...
class FindSumPairs {
            ...
            final int[] nums1;
            final int[] nums2;
            final Map<Integer, Integer> cnt1;
            final Map<Integer, Integer> cnt2;
            final TreeSet<Integer> set1;
            ...
            public FindSumPairs(int[] nums1, int[] nums2) {
                ...
                this.cnt2 = cnt(nums2);
                set1 = new TreeSet<>();
                set1.addAll(cnt1.keySet());
            }

            private Map<Integer, Integer> cnt(int[] nums) {
            ...
            public int count(int tot) {
                int ans = 0;
                for (int num1 : set1.headSet(tot)) {
                    ans += (cnt1.getOrDefault(num1, 0) * cnt2.getOrDefault(tot - num1, 0));
                }
                return ans;
            }
}
