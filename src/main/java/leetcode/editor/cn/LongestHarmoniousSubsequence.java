...
<div><div>Related Topics</div><div><li>数组</li><li>哈希表</li><li>计数</li><li>排序</li><li>滑动窗口</li></div></div><br><div><li>👍 431</li><li>👎 0</li></div>
*/
...
class Solution {
    public int findLHS(int[] nums) {
        ...
        TreeSet<Integer> keys = new TreeSet<>(cnt.keySet());
        for (Integer key : keys) {
            Integer higher = keys.higher(key);
            if (higher != null && higher - key == 1) {
