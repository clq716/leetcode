...
<div><div>Related Topics</div><div><li>数组</li><li>哈希表</li><li>矩阵</li></div></div><br><div><li>👍 1369</li><li>👎 0</li></div>
*/

package leetcode.editor.cn;
public class _0036_ValidSudoku{
    public static void main(String[] args) {
        Solution solution = new _0036_ValidSudoku().new Solution();
    }
    ...
    public boolean isValidSudoku(char[][] board) {
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            for (int j = 0; j < board[0].length; j++) {
                ...
                int idx2 = board[j][i] - '1';
                if (row[idx2]) return false;
                else row[idx2] = true;

                int idx3 = board[j/3+(i/3)*3][j%3+(i%3)*3] - '1';
                if (block[idx3]) return false;
                else block[idx3] = true;
            }
        }
