...
public class _3025_FindTheNumberOfWaysToPlacePeopleI{
    public static void main(String[] args) {
       Solution solution = new _3025_FindTheNumberOfWaysToPlacePeopleI().new Solution();
    }
